...
本仓库根据vtk9.3.0，qt5.12.12编译。

vtk9.3.0_debug和vtk9.3.0_release两个版本的库文件不可通用，qt中的pro文件的配置方法如下
...
根据实际情况修改路径即可。vs的配置方法网上有不少教程，配置比较简单，不再赘述。

**qtTest**中的代码为测试配置是否正确的部分，qt5和qt6均支持打开。



如果觉得有价值，可以捐1毛钱电费。

<img src="image/1708158267092.jpg" alt="1708158267092" style="zoom: 33%;" />